...
describe('Simlife generator for server', () => {
...
describe('Simlife generator entity for angularX', () => {
    ...
    describe('with angular suffix', () => {
        ...
        it('creates expected default files', () => {
            ...
            assert.fileContent('.simlife/Foo.json', 'angularJSSuffix');
        });
    });

    describe('Simlife generator entity with all languages', () => {
        describe('no dto, no service, no pagination', () => {
            beforeEach((done) => {
                helpers.run(require.resolve('../generators/entity'))
                    .inTmpDir((dir) => {
    ...
    describe('with client-root-folder', () => {
        ...
        it('creates expected default files', () => {
            ...
            assert.fileContent('.simlife/Foo.json', 'clientRootFolder');
        });
    });
    ...
    describe('Simlife generator entity with all languages and client-root-folder', () => {
        describe('no dto, no service, no pagination', () => {
            beforeEach((done) => {
                helpers.run(require.resolve('../generators/entity'))
                    .inTmpDir((dir) => {
