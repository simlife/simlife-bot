...
describe('Simlife Heroku Sub Generator', () => {
    const herokuAppName = 'simlife-test';
    let stub;
    ...
    describe('monolith application', () => {
        describe('with an unavailable app name', () => {
            const autogeneratedAppName = 'simlife-new-name';
            beforeEach((done) => {
        ...
        describe('with existing app', () => {
            const existingHerokuAppName = 'simlife-existing';
            beforeEach((done) => {
