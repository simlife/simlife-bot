    ...
    context('Default configuration with', () => {
        describe('AngularX', () => {
            beforeEach((done) => {
                helpers.run(path.join(__dirname, '../generators/app'))
                    .withOptions({ skipInstall: true, skipChecks: true, simPrefix: 'test' })
                    .withPrompts({
                        baseName: 'simlife',
        ...
        describe('React', () => {
            beforeEach((done) => {
                helpers.run(path.join(__dirname, '../generators/app'))
                    .withOptions({
                        skipInstall: true, skipChecks: true, simPrefix: 'test', experimental: true
                    })
                    .withPrompts({
                        baseName: 'simlife',
    ...
    context('Application names', () => {
        describe('package names', () => {
            ...
            it('creates expected files with correct package names', () => {
                assert.file([
                    `${SERVER_MAIN_SRC_DIR}com/otherpackage/SimlifeApp.java`
                ]);
                assert.fileContent(`${SERVER_MAIN_SRC_DIR}com/otherpackage/SimlifeApp.java`, /package com\.otherpackage;/);
                assert.fileContent(`${SERVER_MAIN_SRC_DIR}com/otherpackage/SimlifeApp.java`, /public class SimlifeApp/);
            });
        });
