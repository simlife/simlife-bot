...
describe('simlife cli utils test', () => {
    describe('getArgs', () => {
    ...
    describe('getCommand', () => {
        describe('when called with only cmd', () => {
            it('returns a default command', () => {
                expect(cliUtil.getCommand('app')).to.eql('simlife:app');
            });
        });
        ...
        describe('when called with cmd, args & valid opts', () => {
            ...
            it('returns a command with argument', () => {
                expect(cliUtil.getCommand('app', argument, { argument })).to.eql('simlife:app bar foo');
            });
        });
    });
