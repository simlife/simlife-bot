...
describe('Simlife Docker Compose Sub Generator', () => {
    describe('only gateway', () => {
        ...
        it('creates simlife-registry content', () => {
            assert.fileContent('docker-compose.yml', /simlife-registry:8761\/config/);
        });
    ...
    describe('gateway and one microservice, with elk', () => {
        ...
        it('creates compose file without zipkin, without curator', () => {
            assert.noFileContent('docker-compose.yml', /simlife-zipkin/);
            assert.noFileContent('docker-compose.yml', /simlife-curator/);
        });
        it('creates simlife-registry content', () => {
            assert.fileContent('docker-compose.yml', /simlife-registry:8761\/config/);
        });
    ...
    describe('gateway and one microservice, with zipkin', () => {
        ...
        it('creates compose file with zipkin, without curator', () => {
            assert.fileContent('docker-compose.yml', /simlife-zipkin/);
            assert.noFileContent('docker-compose.yml', /simlife-curator/);
        });
        it('creates simlife-registry content', () => {
            assert.fileContent('docker-compose.yml', /simlife-registry:8761\/config/);
    ...
    describe('gateway and one microservice, with curator', () => {
        ...
        it('creates compose file without zipkin, with curator', () => {
            assert.noFileContent('docker-compose.yml', /simlife-zipkin/);
            assert.fileContent('docker-compose.yml', /simlife-curator/);
        });
        it('creates simlife-registry content', () => {
            assert.fileContent('docker-compose.yml', /simlife-registry:8761\/config/);
        });
