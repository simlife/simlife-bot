...
const expectedFiles = {
    ...
    elk: [
        './ocp/monitoring/simlife-monitoring.yml'
    ],
    eurekaregistry: [
        './ocp/registry/simlife-registry.yml',
...
describe('Simlife OpenShift Sub Generator', () => {
    describe('only gateway', () => {
        ...
        it('creates expected registry files and content', () => {
            ...
            assert.fileContent('./ocp/registry/simlife-registry.yml', /# base64 encoded "openshiftpaas"/);
        });
