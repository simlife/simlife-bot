...
describe('Simlife Rancher Compose Sub Generator', () => {
    describe('only gateway', () => {
        ...
        it('creates expected default files', () => {
            ...
            assert.fileContent('docker-compose.yml', /image: simliferepository\/jhgate/);
        });
    });
    ...
    describe('only one microservice', () => {
        ...
        it('creates expected default files', () => {
            assert.file(expectedFiles.ranchercompose);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/msmysql/);
        });
    });
    ...
    describe('gateway, uaa server and one microservice, with elk', () => {
        ...
        it('creates expected default files', () => {
            ...
            assert.fileContent('docker-compose.yml', /image: simliferepository\/jhgate/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/msmysql/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/uaaserver/);
    ...
    describe('loadbalancing and multi microservices, with elk', () => {
        ...
        it('creates expected default files', () => {
            ...
            assert.noFileContent('docker-compose.yml', /image: rancher\/load-balancer-service/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/msmysql/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/mspsql/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/msmariadb/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/msmongodb/);
            // Validate rancher-compose
            assert.noFileContent('rancher-compose.yml', /lb:/);
            assert.fileContent('rancher-compose.yml', /msmysql-app:/);
    ...
    describe('gateway and 1 microservice, with Cassandra cluster', () => {
        ...
        it('creates expected default files', () => {
            ...
            // Validate docker compose file
            assert.fileContent('docker-compose.yml', /image: simliferepository\/jhgate/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/mscassandra/);
            // Validate rancher-compose
            assert.fileContent('rancher-compose.yml', /jhgate-app:/);
    ...
    describe('loadbalancing and a monolith app', () => {
        ...
        it('creates expected default files', () => {
            assert.file(expectedFiles.ranchercompose);
            assert.fileContent('docker-compose.yml', /image: rancher\/load-balancer-service/);
            assert.fileContent('docker-compose.yml', /image: simliferepository\/samplemysql/);
            // Validate rancher-compose
