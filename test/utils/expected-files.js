...
const expectedFiles = {
    ...
    server: [
        ...
        `${SERVER_MAIN_SRC_DIR}com/mycompany/myapp/SimlifeApp.java`,
    ...
    client: [
        ...
        `${CLIENT_MAIN_SRC_DIR}content/images/simlife.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/simlife2x.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/simlife192.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/simlife256.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/simlife384.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/simlife512.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/logo-simlife.png`,
    ...
    eureka: [
        ...
        `${DOCKER_DIR}simlife-registry.yml`
    ],
