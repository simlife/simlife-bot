...
/**
 * Removes files that where generated in previous Simlife versions and therefore
 * need to be removed.
 *
...
function cleanupOldFiles(generator) {
    if (generator.isSimlifeVersionLessThan('3.2.0')) {
    ...
    if (generator.isSimlifeVersionLessThan('5.0.0')) {
...
/**
 * Removes server files that where generated in previous Simlife versions and therefore
 * need to be removed.
 *
 * @param {any} generator - reference to generator
...
function cleanupOldServerFiles(generator, javaDir, testDir, mainResourceDir, testResourceDir) {
    if (generator.isSimlifeVersionLessThan('3.5.0')) {
    ...
    if (generator.isSimlifeVersionLessThan('3.6.0')) {
        generator.removeFile(`${javaDir}config/HerokuDatabaseConfiguration.java`);
    }
    if (generator.isSimlifeVersionLessThan('3.10.0')) {
    ...
    if (generator.isSimlifeVersionLessThan('3.11.0')) {
        generator.removeFile(`${CLIENT_MAIN_SRC_DIR}app/layouts/navbar/active-link.directive.js`);
    }
    if (generator.isSimlifeVersionLessThan('3.12.0')) {
    ...
    if (generator.isSimlifeVersionLessThan('4.0.0')) {
        ...
        generator.removeFile(`${javaDir}config/simLifeProperties.java`);
    ...
    if (generator.isSimlifeVersionLessThan('4.3.0')) {
    ...
    if (generator.isSimlifeVersionLessThan('4.7.1')) {
    ...
    if (generator.isSimlifeVersionLessThan('4.11.1')) {
        generator.removeFile(`${CLIENT_MAIN_SRC_DIR}app/app.main-aot.ts`);
    }
    if (generator.isSimlifeVersionLessThan('4.13.1')) {
