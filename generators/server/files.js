...
const serverFiles = {
    ...
    docker: [
        ...
        },
        {
            ...
            templates: [
                'keycloak.yml',
                { file: 'config/realm-config/simlife-realm.json', renameTo: () => 'realm-config/simlife-realm.json' },
                { file: 'config/realm-config/simlife-users-0.json', method: 'copy', renameTo: () => 'realm-config/simlife-users-0.json' }
            ]
        },
    ],
    serverBuild: [
    ...
    serverJavaConfig: [
        ...
        },
        {
            ...
            templates: [
                ...
                { file: 'package/config/metrics/SimlifeHealthIndicatorConfiguration.java', renameTo: generator => `${generator.javaDir}config/metrics/SimlifeHealthIndicatorConfiguration.java` },
    ...
    return {
        ...
        writeFiles() {
            if (calledByBlueprint) {
                this.writeFilesToDisk(serverFiles, this, false, this.fetchFromInstalledSimlife('server/templates'));
            } else {
