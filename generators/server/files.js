    ...
    return {
        ...
        writeDockerFiles() {
            ...
            if (this.serviceDiscoveryType) {
                ...
                if (this.serviceDiscoveryType === 'eureka') {
                    this.template(`${DOCKER_DIR}_simlife-registry.yml`, `${DOCKER_DIR}simlife-registry.yml`);
            ...
            if (this.authenticationType === 'oauth2') {
                ...
                this.template(`${DOCKER_DIR}config/realm-config/_simlife-realm.json`, `${DOCKER_DIR}realm-config/simlife-realm.json`);
                this.copy(`${DOCKER_DIR}config/realm-config/simlife-users-0.json`, `${DOCKER_DIR}realm-config/simlife-users-0.json`);
            }
        },
        ...
        writeServerJavaConfigFiles() {
            ...
            if (this.databaseType === 'cassandra') {
                ...
                this.template(`${SERVER_MAIN_SRC_DIR}package/config/metrics/_SimlifeHealthIndicatorConfiguration.java`, `${javaDir}config/metrics/SimlifeHealthIndicatorConfiguration.java`);
