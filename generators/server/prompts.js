...
function askForServerSideOpts(meta) {
    ...
    const prompts = [
        ...
        },
        {
            ...
            choices: [
                {
                    value: 'eureka',
                    name: 'Simlife Registry (uses Eureka, provides Spring Cloud Config support and monitoring dashboards)'
                },
                {
                    value: 'consul',
                    name: 'Consul'
        ...
        },
        {
            ...
            type: 'list',
            name: 'serviceDiscoveryType',
            message: 'Do you want to use the Simlife Registry to configure, monitor and scale your application?',
            choices: [
                {
                    value: false,
                    name: 'No'
        ...
        },
        {
            ...
            choices: (response) => {
                ...
                if (applicationType === 'monolith' && response.serviceDiscoveryType !== 'eureka') {
                    ...
                    opts.push({
                        value: 'uaa',
                        name: 'Authentication with Simlife UAA server (the server must be generated separately)'
                    });
                }
                return opts;
            },
        ...
        },
        {
            ...
            validate: (input) => {
                ...
                return `Could not find a valid Simlife UAA server in path "${input}"`;
            }
        },
        {
            type: 'list',
    ...
    this.prompt(prompts).then((props) => {
        ...
        // JWT authentication is mandatory with Eureka, so the Simlife Registry
