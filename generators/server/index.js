    ...
    _prompting() {
        return {
            ...
            setSharedConfigOptions() {
                ...
                this.DOCUMENTATION_URL = constants.SIMLIFE_DOCUMENTATION_URL;
                this.DOCUMENTATION_ARCHIVE_URL = `${constants.SIMLIFE_DOCUMENTATION_URL + constants.SIMLIFE_DOCUMENTATION_ARCHIVE_PATH}v${this.simlifeVersion}`;
            }
        };
    }
