...
public class OAuth2AuthenticationServiceTest {
    ...
    public void init() {
        ...
        jSimlifeProperties = new SimlifeProperties();
        jSimlifeProperties.getSecurity().getClientAuthorization().setAccessTokenUri("http://uaa/oauth/token");
        ...
        authorizationClient = new UaaTokenEndpointClient(restTemplate, jSimlifeProperties, oAuth2Properties);
