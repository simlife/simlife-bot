...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(SimlifeProperties jSimlifeProperties) {
        this.jSimlifeProperties = jSimlifeProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(jSimlifeProperties.getHttp().getCache().getTimeToLiveInDays());
    }
