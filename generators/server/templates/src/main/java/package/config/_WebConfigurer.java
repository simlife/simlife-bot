...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private final SimlifeProperties jSimlifeProperties;<% if (cacheProvider === 'hazelcast') { %>

    private final HazelcastInstance hazelcastInstance;<% } %>

    private MetricRegistry metricRegistry;

    public WebConfigurer(Environment env, SimlifeProperties jSimlifeProperties<% if (cacheProvider === 'hazelcast') { %>, HazelcastInstance hazelcastInstance<% } %>) {
