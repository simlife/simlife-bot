...
// simlife-needle-add-social-connection-factory-import-package
...
public class SocialConfiguration implements SocialConfigurer {
    ...
    public void addConnectionFactories(ConnectionFactoryConfigurer connectionFactoryConfigurer, Environment environment) {
        ...
        // simlife-needle-add-social-connection-factory
    }
    ...
    @Bean
    public SignInAdapter signInAdapter(UserDetailsService userDetailsService, SimlifeProperties jSimlifeProperties<% if (authenticationType === 'jwt') { %>,
            TokenProvider tokenProvider<% } %>) {
        return new CustomSignInAdapter(userDetailsService, jSimlifeProperties<% if (authenticationType === 'jwt') { %>,
            tokenProvider<% } %>);
    }
