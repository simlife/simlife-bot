...
public class WebsocketConfiguration extends AbstractWebSocketMessageBrokerConfigurer {
    ...
    public WebsocketConfiguration(SimlifeProperties jSimlifeProperties) {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        String[] allowedOrigins = Optional.ofNullable(jSimlifeProperties.getCors().getAllowedOrigins()).map(origins -> origins.toArray(new String[0])).orElse(new String[0]);
