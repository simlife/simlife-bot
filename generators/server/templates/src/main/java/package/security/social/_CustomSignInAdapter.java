...
public class CustomSignInAdapter implements SignInAdapter {
    ...
    public CustomSignInAdapter(UserDetailsService userDetailsService, SimlifeProperties jSimlifeProperties<% if (authenticationType === 'jwt') { %>,
    ...
    public String signIn(String userId, Connection<?> connection, NativeWebRequest request){
        ...
        return jSimlifeProperties.getSocial().getRedirectAfterSignIn();
    }
