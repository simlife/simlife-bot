...
public abstract class OAuth2TokenEndpointClientAdapter implements OAuth2TokenEndpointClient {
    ...
    protected final SimlifeProperties jSimlifeProperties;
    protected final OAuth2Properties oAuth2Properties;

    public OAuth2TokenEndpointClientAdapter(RestTemplate restTemplate, SimlifeProperties jSimlifeProperties, OAuth2Properties oAuth2Properties) {
    ...
    protected String getTokenEndpoint() {
        String tokenEndpointUrl = jSimlifeProperties.getSecurity().getClientAuthorization().getAccessTokenUri();
