...
module.exports = class extends BaseGenerator {
    constructor(args, opts) {
        ...
        // This adds support for a `--sim-prefix` flag
        this.option('sim-prefix', {
                ...
                if (this.skipClient) {
                    ...
                    if (!this.options['skip-install']) {
                        if (this.clientPackageManager === 'yarn') {
                            ...
                            this.log(chalk.bold(`\nInstalling simlife-bot@${this.simlifeVersion} locally using npm`));
                            this.npmInstall();
                        }
                    }
                }
                                ...
                                if (!gitDir) {
                                    this.gitExec('init', { trace: false }, () => {
                                        this.gitExec('add -A', { trace: false }, () => {
                                            this.gitExec(`commit -am "Initial application generated by Simlife-${this.simlifeVersion}"`, { trace: false }, () => this.log(chalk.green.bold('Application successfully committed to Git.')));
                                        });
                                    });
                                }
                            });
