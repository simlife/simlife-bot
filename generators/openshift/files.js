    ...
    return {
        ...
        writeRegistryFiles() {
            ...
            if (this.serviceDiscoveryType === 'eureka') {
                this.template('registry/simlife-registry.yml.ejs', `${this.directoryPath}/ocp/registry/simlife-registry.yml`);
        ...
        writeElkFiles() {
            ...
            this.template('monitoring/simlife-monitoring.yml.ejs', `${this.directoryPath}/ocp/monitoring/simlife-monitoring.yml`);
        },
        ...
        writePrometheusFiles() {
            ...
            this.template('monitoring/simlife-metrics.yml.ejs', `${this.directoryPath}/ocp/monitoring/simlife-metrics.yml`);
        },
