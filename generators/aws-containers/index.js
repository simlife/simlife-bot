...
const databaseTypes = require('simlife-core').SimlifeDatabaseTypes;
...
module.exports = class extends BaseGenerator {
    ...
    get initializing() {
        return {
            bonjour() {
                this.log(chalk.bold('This AWS generator will help you deploy your Simlife app as a Docker container on AWS.'));
            },
            option() {
