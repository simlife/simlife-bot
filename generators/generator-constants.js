...
const DOCKER_SIMLIFE_REGISTRY = 'simlife/simlife-registry:v3.2.4';
...
const DOCKER_SIMLIFE_CONSOLE = 'simlife/simlife-console:v3.0.1';
const DOCKER_SIMLIFE_CURATOR = 'simlife/simlife-curator:v3.0.1';
const DOCKER_SIMLIFE_ELASTICSEARCH = 'simlife/simlife-elasticsearch:v3.0.1';
const DOCKER_SIMLIFE_LOGSTASH = 'simlife/simlife-logstash:v3.0.1';
const DOCKER_SIMLIFE_IMPORT_DASHBOARDS = 'simlife/simlife-import-dashboards:v3.0.1';
const DOCKER_SIMLIFE_ZIPKIN = 'simlife/simlife-zipkin:v3.0.1';
const DOCKER_TRAEFIK = 'traefik:1.4';
const DOCKER_CONSUL = 'consul:0.9.3';
const DOCKER_CONSUL_CONFIG_LOADER = 'simlife/consul-config-loader:v0.2.2';
...
const SIMLIFE_DOCUMENTATION_URL = 'http://www.simlife.tech';
const SIMLIFE_DOCUMENTATION_ARCHIVE_PATH = '/documentation-archive/';
...
const constants = {
    ...
    SIMLIFE_DOCUMENTATION_URL,
    SIMLIFE_DOCUMENTATION_ARCHIVE_PATH,

    DOCKER_SIMLIFE_REGISTRY,
    DOCKER_JAVA_JRE,
    DOCKER_MYSQL,
    DOCKER_MARIADB,
    DOCKER_POSTGRESQL,
    ...
    DOCKER_ZOOKEEPER,
    DOCKER_SONAR,
    DOCKER_SIMLIFE_CONSOLE,
    DOCKER_SIMLIFE_CURATOR,
    DOCKER_SIMLIFE_ELASTICSEARCH,
    DOCKER_SIMLIFE_LOGSTASH,
    DOCKER_SIMLIFE_IMPORT_DASHBOARDS,
    DOCKER_SIMLIFE_ZIPKIN,
    DOCKER_TRAEFIK,
    DOCKER_CONSUL,
