...
const createServiceProfileRoleWithAttachedPolicies = () => {
    ...
    const description = 'Default Elastic Beanstalk Service profile created by Simlife.';
...
const createInstanceRoleWithAttachedPolicies = () => {
    ...
    const description = 'Default Elastic Beanstalk instance profile created by Simlife.';
    const assumedPolicyDoc = `{
  "Version": "2008-10-17",
  "Statement": [
    {
