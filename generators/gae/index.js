        ...
        return {
            ...
            createCloudSqlInstance() {
                ...
                exec(cmd, (err, stdout, stderr) => {
                    ...
                    this.gcpCloudSqlInstanceName = execSync(`gcloud sql instances describe simlife --format="value(connectionName)" --project="${this.gcpProjectId}"`, { encoding: 'utf8' });
            ...
            createCloudSqlLogin() {
                ...
                const name = this.gcpCloudSqlInstanceName.split(':')[2];
                exec(`gcloud sql users list -i simlife --format='value(name)' --project="${this.gcpProjectId}"`, (err, stdout) => {
