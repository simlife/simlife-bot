    ...
    common: [
        {
            templates: [
                ...
                { file: 'webpack/logo-simlife.png', method: 'copy' }
            ]
        }
    ],
    css: [
    ...
    image: [
        {
            path: MAIN_SRC_DIR,
            templates: [
                { file: 'content/images/simlife.png', method: 'copy' },
                { file: 'content/images/simlife2x.png', method: 'copy' },
                { file: 'content/images/simlife192.png', method: 'copy' },
                { file: 'content/images/simlife256.png', method: 'copy' },
                { file: 'content/images/simlife384.png', method: 'copy' },
                { file: 'content/images/simlife512.png', method: 'copy' },
                { file: 'content/images/logo-simlife.png', method: 'copy' }
            ]
        }
    ],
    swagger: [
...
function writeFiles(calledByBlueprint) {
    ...
    if (calledByBlueprint) {
        this.writeFilesToDisk(files, this, false, this.fetchFromInstalledSimlife('client/templates/angular'));
    } else {
