    ...
    image: [
        {
            path: MAIN_SRC_DIR,
            templates: [
                { file: 'content/images/_simlife.png', method: 'copy' },
                { file: 'content/images/_simlife2x.png', method: 'copy' },
                { file: 'content/images/_logo-simlife.png', method: 'copy' }
            ]
        }
    ],
    swagger: [
    ...
    clientTestFw: [
        ...
        },
        {
            ...
            templates: [
                ...
                'e2e/page-objects/_sim-page-objects.ts',
                '_protractor.conf.js'
            ]
        }
    ]
