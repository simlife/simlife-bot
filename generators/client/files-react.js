    ...
    image: [
        {
            path: MAIN_SRC_DIR,
            templates: [
                { file: 'static/images/simlife.png', method: 'copy' },
                { file: 'static/images/simlife2x.png', method: 'copy' },
                { file: 'static/images/simlife192.png', method: 'copy' },
                { file: 'static/images/simlife256.png', method: 'copy' },
                { file: 'static/images/simlife384.png', method: 'copy' },
                { file: 'static/images/simlife512.png', method: 'copy' },
                { file: 'static/images/logo-simlife.png', method: 'copy' },
                { file: 'static/images/logo-simlife-react.svg', method: 'copy' }
            ]
        }
    ],
    swagger: [
...
function writeFiles(calledByBlueprint) {
    ...
    if (calledByBlueprint) {
        this.writeFilesToDisk(files, this, false, this.fetchFromInstalledSimlife('client/templates/react'));
    } else {
