...
(function() {
    ...
    angular
        ...
        .factory('<%=simPrefixCapitalized%>HealthService', <%=simPrefixCapitalized%>HealthService);

    <%=simPrefixCapitalized%>HealthService.$inject = ['$rootScope', '$http'];

    function <%=simPrefixCapitalized%>HealthService ($rootScope, $http) {
        var separator = '.';
        var service = {
