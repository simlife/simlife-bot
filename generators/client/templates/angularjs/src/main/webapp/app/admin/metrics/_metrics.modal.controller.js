...
(function() {
    ...
    angular
        ...
        .controller('<%=simPrefixCapitalized%>MetricsMonitoringModalController', <%=simPrefixCapitalized%>MetricsMonitoringModalController);

    <%=simPrefixCapitalized%>MetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function <%=simPrefixCapitalized%>MetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
