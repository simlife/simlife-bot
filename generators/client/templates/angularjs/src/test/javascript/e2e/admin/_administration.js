...
describe('administration', function () {
    ...
    it('should load metrics', function () {
        element(by.css('[ui-sref="<%= simPrefixDashed %>-metrics"]')).click();
        <%_ if (enableTranslation) { _%>
    ...
    it('should load health', function () {
        element(by.css('[ui-sref="<%= simPrefixDashed %>-health"]')).click();
        <%_ if (enableTranslation) { _%>
    ...
    it('should load configuration', function () {
        element(by.css('[ui-sref="<%= simPrefixDashed %>-configuration"]')).click();
        <%_ if (enableTranslation) { _%>
