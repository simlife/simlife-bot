...
describe('Controller Tests', function () {
    ...
    describe('<%=simPrefixCapitalized%>HealthCheckController', function () {
        var $scope, simHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, <%=simPrefixCapitalized%>HealthService) {
            $scope = $injector.get('$rootScope').$new();
            simHealthService = <%=simPrefixCapitalized%>HealthService;
            var locals = {
                '$scope': $scope
            };
            createController = function() {
                $injector.get('$controller')('<%=simPrefixCapitalized%>HealthCheckController as vm', locals);
            };
            createController();
        }));
        ...
        describe('transformHealthData', function () {
            it('should flatten empty health data', function () {
                var data = {};
                var expected = [];
                expect(simHealthService.transformHealthData(data)).toEqual(expected);
            });
