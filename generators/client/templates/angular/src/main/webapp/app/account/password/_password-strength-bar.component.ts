...
@Component({
    selector: '<%= simPrefixDashed %>-password-strength-bar',
    template: `
        <div id="strength">
            <small<% if (enableTranslation) { %> simTranslate="global.messages.validate.newpassword.strength"<% } %>>Password strength:</small>
            <ul id="strengthBar">
                <li class="point"></li>
                <li class="point"></li>
                <li class="point"></li>
