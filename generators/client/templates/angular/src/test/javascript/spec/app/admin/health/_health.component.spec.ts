...
import { <%=simPrefixCapitalized%>HealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { <%=simPrefixCapitalized%>HealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('<%=simPrefixCapitalized%>HealthCheckComponent', () => {

        let comp: <%=simPrefixCapitalized%>HealthCheckComponent;
        let fixture: ComponentFixture<<%=simPrefixCapitalized%>HealthCheckComponent>;
        let service: <%=simPrefixCapitalized%>HealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [<%=angularXAppName%>TestModule],
                declarations: [<%=simPrefixCapitalized%>HealthCheckComponent],
                providers: [
                    <%=simPrefixCapitalized%>HealthService
                ]
            })
            .overrideTemplate(<%=simPrefixCapitalized%>HealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(<%=simPrefixCapitalized%>HealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(<%=simPrefixCapitalized%>HealthService);
        });
