...
import { <%=simPrefixCapitalized%>LoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: <%=simPrefixCapitalized%>LoginModalComponent;
        let fixture: ComponentFixture<<%=simPrefixCapitalized%>LoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [<%=simPrefixCapitalized%>LoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(<%=simPrefixCapitalized%>LoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(<%=simPrefixCapitalized%>LoginModalComponent);
