...
import { NavBarPage, SignInPage<%_ if (authenticationType !== 'oauth2') { _%>, PasswordPage, SettingsPage<%_ } _%> } from './../page-objects/sim-page-objects';
<%_
...
describe('account', () => {
    ...
    it('should fail to login with bad password', () => {
        ...
        <%_ } else { _%>
        const expect1 = /Welcome, Java Simlife!/;
        <%_ } _%>
