    ...
    get default() {
        return {
            ...
            parseJDL() {
                ...
                try {
                    const jdlObject = simCore.convertToJDL(
                        simCore.parseFromFiles(this.jdlFiles),
                        this.prodDatabaseType,
                        this.applicationType,
                        this.baseName
                    );
                    const entities = simCore.convertToSimlifeJSON({
                        jdlObject,
                        databaseType: this.prodDatabaseType,
                        applicationType: this.applicationType
                    });
                    this.log('Writing entity JSON files.');
                    this.changedEntities = simCore.exportToJSON(entities, this.options.force);
