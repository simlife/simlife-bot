...
function importJDL() {
    ...
    const jdlImporter = new simCore.JDLImporter(this.jdlFiles, {
...
module.exports = class extends ImporterGenerator {
    ...
    get initializing() {
        return {
            ...
            getConfig() {
                if (!this.config.get('baseName') && simCore.FileUtils.doesFileExist('.yo-rc.json')) {
            ...
            generateApplications() {
                ...
                if (this.importState.exportedApplications.length === 1) {
                    ...
                    this.applicationsLeftToGenerate = this.importState.exportedApplications
                        .map(application => application['simlife-bot'].baseName);
                }
            },
...
function generateApplicationFiles(args) {
    callSubGenerator(args.generator, '..', 'app', {
        ...
        'skip-user-management': args.application['simlife-bot'].skipUserManagement,
        'sim-prefix': args.application['simlife-bot'].simPrefix,
