...
function writeFiles(calledByBlueprint) {
    return {
        saveRemoteEntityPath() {
            ...
            this.copy(
                `${this.microservicePath}/${this.simlifeConfigDirectory}/${this.entityNameCapitalized}.json`,
                this.destinationPath(`${this.simlifeConfigDirectory}/${this.entityNameCapitalized}.json`)
            );
        },
        ...
        writeServerFiles() {
            ...
            if (calledByBlueprint) {
                this.writeFilesToDisk(serverFiles, this, false, this.fetchFromInstalledSimlife('entity-server/templates'));
            } else {
