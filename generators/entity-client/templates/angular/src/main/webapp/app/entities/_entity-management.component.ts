...
import { JhiEventManager, <% if (pagination !== 'no') { %>JhiParseLinks, <% } %>JhiAlertService<% if (fieldsContainBlob) { %>, JhiDataUtils<% } %> } from 'ng-simlife';
...
@Component({
    selector: '<%= simPrefixDashed %>-<%= entityFileName %>',
