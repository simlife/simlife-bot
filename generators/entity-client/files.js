        ...
        writeClientFiles() {
            ...
            if (this.clientFramework === 'angularX') {
                ...
                if (calledByBlueprint) {
                    this.writeFilesToDisk(angularFiles, this, false, this.fetchFromInstalledSimlife(`entity-client/templates/${CLIENT_NG2_TEMPLATES_DIR}`));
                } else {
                ...
                if (calledByBlueprint) {
                    this.writeFilesToDisk(reactFiles, this, false, this.fetchFromInstalledSimlife(`entity-client/templates/${CLIENT_REACT_TEMPLATES_DIR}`));
                } else {
