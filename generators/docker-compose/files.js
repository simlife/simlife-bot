    ...
    return {
        ...
        writeRegistryFiles() {
            if (this.serviceDiscoveryType === 'eureka') {
                this.template('simlife-registry.yml.ejs', 'simlife-registry.yml');
            }
        ...
        writeKeycloakFiles() {
            ...
            this.template('realm-config/simlife-realm.json.ejs', 'realm-config/simlife-realm.json');
            this.template('realm-config/simlife-users-0.json.ejs', 'realm-config/simlife-users-0.json');
        },

        writeElkFiles() {
            if (this.monitoring !== 'elk') return;

            this.template('simlife-console.yml.ejs', 'simlife-console.yml');
