    ...
    return {
        ...
        writeRegistryFiles() {
            if (this.serviceDiscoveryType === 'eureka') {
                this.template('_simlife-registry.yml', 'simlife-registry.yml');
            }
        ...
        writeKeycloakFiles() {
            ...
            this.template('realm-config/_simlife-realm.json', 'realm-config/simlife-realm.json');
            this.template('realm-config/_simlife-users-0.json', 'realm-config/simlife-users-0.json');
        },

        writeElkFiles() {
            if (this.monitoring !== 'elk') return;

            this.template('_simlife-console.yml', 'simlife-console.yml');
